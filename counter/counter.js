...
function startCounter(){
  ...
  document.getElementById("counter-conttrol-div").style.display = 'none';
  ...
  url.searchParams.set("date",dateStringchoice);
  url.searchParams.set("hours",hourStringchoice);
  url.searchParams.set("minutes",minuteStringchoice);
  url.searchParams.set("seconds",secondsStringchoice);
...
function stopcounter(){
  document.getElementById("counter-conttrol-div").style.display = 'block';
